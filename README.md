...
**Cat Run 2D** é um jogo de plataforma desenvolvido em Java. O objetivo principal é sobreviver e pontuar de forma infinita ("Infinite Runner") 
enquanto o personagem principal percorre um cenário 2D, desviando de obstáculos e inimigos.
